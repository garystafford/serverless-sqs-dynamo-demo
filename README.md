# iot_dynamodb_getMessage

This is a sample template for iot_dynamodb_getMessage - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name iot_dynamodb_getmessage \
...
```bash
sam logs -n HelloWorldFunction --stack-name iot_dynamodb_getmessage --tail
```
...
```bash
aws cloudformation delete-stack --stack-name iot_dynamodb_getmessage
```
